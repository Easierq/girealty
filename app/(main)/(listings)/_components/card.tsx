...
export const Card = ({ img }: Props) => {
  return (
    <div className="grid grid-cols-1 gap-2">
      {/* thumbnail */}
      <div className="group relative h-[180px] w-auto overflow-hidden bg-[#F3F5F7] rounded-[8px]">
        <div className=" absolute top-2 left-2 right-2 z-10 flex items-start justify-between">
          <div className="w-fit px-3.5 py-1 font-inter text-[10px] font-semibold uppercase bg-white rounded-full">
            For sale
          </div>
