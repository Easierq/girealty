...
const formSchema = z.object({
  park: z.coerce.number(),
});

export const ParkForm = ({ initialData, listingId }: LatFormProps) => {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      park: initialData?.park || undefined,
    },
  });
      ...
      {!isEditing && (
        <p
          className={cn(
            ...
            !initialData.park && "text-slate-500 italic"
          )}
          onClick={toggleEdit}
        >
          {initialData.park}
                ...
                <FormItem>
                  <FormControl>
                    <Input
                      ...
                      placeholder="Set number of parks..."
