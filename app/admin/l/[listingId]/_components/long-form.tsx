...
export const LongForm = ({ initialData, listingId }: LatFormProps) => {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      longtitude: initialData?.longtitude || undefined,
    },
  });
      ...
      {!isEditing && (
        <p
          className={cn(
            ...
            !initialData.longtitude && "text-slate-500 italic"
          )}
          onClick={toggleEdit}
        >
          {initialData.longtitude}
        </p>
      )}
      {isEditing && (
        <Form {...form}>
                ...
                <FormItem>
                  <FormControl>
                    <Input
                      ...
                      placeholder="Set listing longtitude..."
